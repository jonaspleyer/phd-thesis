...
%###################################################################################################
\pagebreak
\section{An AI-driven workflow to map Biology to \acsp{abm} at the example of elongated Bacteria}
\subsection{Introduction to Spatial Elongated Bacteria}
\subsection{Mathematical Models}
\subsection{Taxonomy}
\subsection{Analysis of AI-Tools}
\subsection{Discussion}

%###################################################################################################
\pagebreak
\section{Parameter Estimation, Model Validation \& Reduction for Mechanical Models of Elongated Bacteria}
\subsection{A Computational Model for Rod-Shaped Bacteria}
