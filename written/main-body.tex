...
\renewcommand{\thesubsection}{S\arabic{suppsubsection}}
...
\makeatletter
\renewcommand{\subsection}{\@ifstar{\oldsubsection*}{\stepcounter{suppsubsection}\oldsubsection}}
