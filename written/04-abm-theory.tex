...
Within any biological system, cells either die via varying mechanisms such as apoptosis or necrosis
or divide, thus creating new daughter cells which are usually considered distinct entities.
However when modeling such systems, it is important to also consider other forms of cell addition
and removal.
This is especially important since most systems studied only represent a slice of the actual
biological reality which is often embedded in a larger complex.
...
This is common for microfluidic devices in which bacteria can be kept within their growth phase and
excess cells are simply sucked away through microfluidic tubules.
\todo{citation}
A common method to avoid the pitfalls that are associated with the aforementioned challenges, is by
enforcing spatially periodic boundary conditions.
This is a common choice for dense populations such as epithelial cell sheets.
