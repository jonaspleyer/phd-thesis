...
other such as cellular fusion~\cite{Ogle2004,Whitlock2024} or multiple
fission~\cite{Suresh1994,Peckov1990} exist.
...
The cell's lifetime ends when it reaches final fate such as death or division or at the end of
...
properties but rather defined by their lineage.
...
If two cells with matching internal states sit in at the same location, they can not be
...
particles which is employed throughout statistical physics.
