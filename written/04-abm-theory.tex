...
The next subsections will discuss how the concepts of cellular identity, division and death can be
...
While a set of tools exist that facilitate static spatial segmentation, \todo{insert citations}
the dynamic extension of imaging and tracking cells through space still poses a substantial problem.
\todo{cite cell tracking challenge}
