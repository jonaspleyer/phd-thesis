...
considerations.
Furthermore these considerations are bound by practical limitations and will generally be difficult
to enforce in some systems such as when high stochastic fluctuations lead to decorrelation of any
...
As can be seen from Figure~\ref{fig:theory-thought-experiment-3}, division of cells introduces two new
