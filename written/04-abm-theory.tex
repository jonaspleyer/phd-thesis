...
This section aims to define a space in which individual cells can be represented.
We leverage known biological behaviour as a template for this construction.
...
Overall this exemplifies the need to assign unique identifiers for cells to correctly trace their
lineage.
...
As can be seen from Figure~\ref{fig:theory-thought-experiment-3}, division of
cells introduces two new
