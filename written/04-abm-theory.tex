...
The process of imaging cells and tracking their movement through time and space is a considerable
...
Leaving practical limitations apart, in principle cellular systems are characterized by the fact
that cells are in principle tracable through time and space.
Moreover, this involves keeping track of their lineage by starting at the division of the mother
cell until the final fate of the cell.
...
distinct entities compared to their mother.
However when modeling such systems, it is important to also consider other forms of addition of
cells and their removal.
Most studied systems only represent a slice of the actual biological reality and are embedded in a
larger complex.
Within this scope cells can be added or removed to the observable environment simply by moving
into or out of the observed region.
This is also common in microfluidic devices in which bacteria can be kept in a continuous growth
phase and excess cells are simply sucked away by fluidic forces.
\todo{citation}
...
This is for instance commonly employed in densely packed epithelial cell sheets.
\todo{citation}
