...
\paragraph{Til Death or Division do us part}
Cells generally have finite lifetimes which mostly result either death by mechanisms such as
apoptosis (programmed cell death)~\cite{BOHM2003,Green2010,Raff1998},
autophagy~\cite{Licheva2025,Galluzzi2017} or necrosis~\cite{Fink2005} which can also be regulated
by genetic pathways~\cite{Berghe2014}.
While these outcomes represent the majority of cellular fates, we have to remind ourselves that
other forms such as cellular fusion~\cite{Ogle2004,Whitlock2024} or multiple
fission~\cite{Suresh1994,Peckov1990} do exist.
The former was observed as early as 1837 by Theodor Schwann~\cite{Schwann1847}.
...
The cell's lifetime ends when it reaches a final fate such as in death or division or at the end of
...
\subsection{Changing the Cellular State - Death, Division \& Others}
...
\subsubsection{A Primer on Cellular Reproduction}
...
multiple fission in some \textit{Myxogastria}~\cite{Baldauf1997}.
...
The process of multipolar budding where multiple budding cites develop simultanously at a single
mother cell has been observed in
\textit{Paracoccidioides brasiliensis}~\cite{Almeida2009,Carbonell1967}.
It can also be induced in budding yeast by increasing polarity proteins within the
...
meiosis~\todo{CITATION} into separate daughter cells.
