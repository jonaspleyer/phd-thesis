...
\subsection{Adding and Removing Cells - Division, Death \& Others}
Within any biological system, all cells have finite lifetimes with most fates resulting in either
death via mechanisms such as apoptosis or necrosis or division thus creating new daughter cells
which are considered distinct entities compared to their mother.
...
\todo{fix this; cells can also fuse}
However when modeling such systems, it is important to also consider other forms of cell addition
and removal.
Most studied systems only represent a slice of the actual biological reality which is embedded in a
larger complex.
