...
\label{chapter:overaching-aspects-elongated-bacteria}
...
\begin{itemize}
    ...
    \item discuss table \ref{table:bacterial-aspects}
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c l X}
        ...
        Elongation~\cite{Robert2014,Takeuchi2005,Daniel2003,Cooper1991, Wang2010Robust}, Dormancy
...
Table \ref{table:bacterial-aspects} summarizes these aspects and points to the relevant
experiments.
